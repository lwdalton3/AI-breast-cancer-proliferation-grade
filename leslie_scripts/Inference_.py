...
modelPath = "/home/ldalton/VGG19_CHTN_train_images_may_day.h5"   # model name change names as needed
...
testFolder= "/home/ldalton/test_panels"
#outputDir = "/home/ldalton/results_TCGA_screenshots_pleo1_125"   # will place copy of image in folder according to classification

outputDir = "/home/ldalton/test_results"   # will place copy of image in folder according to classification
...
csvResultPath = "/home/ldalton/test_results.tsv"          # text file with data on each image
